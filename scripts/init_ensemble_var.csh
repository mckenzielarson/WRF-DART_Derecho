...
set n = 1
while ( $n <= $NUM_ENS ) #MLL changed to little num_ens to debug
...
#=================================================================
   ...
   source /etc/profile.d/z00_modules.csh # try this to resolve module: command not found
