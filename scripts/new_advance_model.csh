...
EOF
      ...
      sleep 1 ## MLL added/uncommented this, program is killing jobs prematurely
      ...
      #  MLL changing the above code to this below, but that did not resolve segfaults...must be an issue somewhere else
      #while ($SUCCESS == 0) ## MLL changed to while loop
      #	echo "Waiting for WRF run to finish..."
	#sleep 30
      #end
      #if ($SUCCESS == 1)
      #	echo "WRF complete!"
