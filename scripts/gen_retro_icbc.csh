...
#PBS -A # if using PBS, change this
...
set datefnl   = 2017043018 # set this appropriately #%%%#
set paramfile = ${BASE_DIR}/scripts/param.csh   # set this appropriately #%%%#
