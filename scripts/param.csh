...
source /etc/profile.d/z00_modules.csh # MLL try this to resolve module: command not found
module load cray-mpich          # set this appropriately #%%%#
...
set BASE_DIR         =      # set this appropriately #%%%#
...
set DART_DIR          =            # set this appropriately #%%%#
set WRF_DM_SRC_DIR    =            # set this appropriately #%%%#
set WPS_SRC_DIR       =            # set this appropriately #%%%#
set VAR_SRC_DIR       =            # set this appropriately #%%%#

# for generating wrf template files
set GEO_FILES_DIR     = /glade/u/home/wrfhelp/WPS_GEOG   # MLL use for Derecho # set this appropriately #%%%#
...
set SUPER_PLATFORM      = derecho # MLL changed this from cheyenne
...
#
set COMPUTER_CHARGE_ACCOUNT =   # set this appropriately #%%%#
set EMAIL                   =   # set this appropriately #%%%#

if ( $SUPER_PLATFORM == 'derecho') then
   # cheyenne values (uses 'PBS' queueing system) 
   # set this appropriately #%%%#  ... ALL OF THESE if using PBS
   set FILTER_QUEUE       = main  ## MLL needs to be main for derecho
   set FILTER_TIME        = 3:30:00
   set FILTER_NODES       = 1
   set FILTER_PROCS       = 18
   set FILTER_MPI         = 18
   set ADVANCE_QUEUE       = main
   set ADVANCE_TIME        = 3:30:00
   set ADVANCE_NODES       = 1     ## MLL low because otherwise I had lots of segmentation faults (even after changing the time step)
   set ADVANCE_PROCS       = 18
   set ADVANCE_MPI         = 18
else
